...
struct MESHMERGETEST_API FSkelMeshMergeSectionMapping_BP
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct MESHMERGETEST_API FSkelMeshMergeUVTransform
{
    GENERATED_BODY()
...
*/
// USTRUCT(BlueprintType)
// struct MESHMERGETEST_API FSkelMeshMergeUVTransformMapping
// {
//     GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct MESHMERGETEST_API FSkeletalMeshMergeParams
{
    GENERATED_BODY()
...
UCLASS()
class MESHMERGETEST_API UMeshMergeFunctionLibrary : public UBlueprintFunctionLibrary
{
    GENERATED_BODY()
public:
    /**
